  ...
  return (
    <div className="app-container">
      ...
      <div className="electricity-overlay">
        ...
        <div className="electric-line line-6"></div>
        <div className="electric-line line-7"></div>
        <div className="electric-line line-8"></div>
        <div className="electric-line line-9"></div>
        <div className="electric-line line-10"></div>
      </div>

      <header>
        {/* Logo: Image + Text directly */}
        <div className="logo-container" onClick={() => scrollTo('home')}>
          <img src="/logo_004.png" alt="EnHub GmbH Logo" className="logo-img" />
